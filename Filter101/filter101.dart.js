...
$$.image = {"":
 ["data", "context", "src", "width", "height"],
 super: "Object",
 draw$1: function(im) {
  this.context.drawImage$9(im, 0, 0, 640, 480, 0, 0, 640, 480);
 },
 setImage$0: function() {
  var t1 = ({});
  t1.i_1 = $._ElementFactoryProvider_Element$tag('img');
  t1.i_1 = $.window().get$document().$dom_createElement$1('img');
  $.add$1(t1.i_1.get$on().get$load(), new $.image_setImage_anon(this, t1));
 },
 getImageContext$1: function(canvasid) {
  var canvas = $.window().get$document().$dom_getElementById$1(canvasid);
  canvas.$dom_setAttribute$2('width', '640');
  canvas.$dom_setAttribute$2('height', '480');
  this.context = canvas.getContext$1('2d');
 },
 image$2: function(src, canvasid) {
  this.src = src;
  if (!(canvasid == null)) this.context = this.getImageContext$1(canvasid);
 }
};
...
$$.image_setImage_anon = {"":
 ...
 $call$1: function(event$) {
  this.this_2.draw$1(this.box_0.i_1);
 }
};
...
$.image$ = function(src, canvasid) {
  var t1 = new $.image(null, null, null, null, null);
  t1.image$2(src, canvasid);
  return t1;
};
...
$.main = function() {
  $.image$('buzz.png', 'myCanvas').setImage$0();
};
